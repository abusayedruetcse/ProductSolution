...
namespace LibraryManagementSolution.PublisherStall {
    ...
    export class PurchaseOrderDetailListDialog extends Serenity.Extensions.GridEditorDialog<PurchaseOrderDetailListRow> {
        protected getFormKey() { return PurchaseOrderDetailListForm.formKey; }
        protected getLocalTextPrefix() { return PurchaseOrderDetailListRow.localTextPrefix; }

        protected form: PurchaseOrderDetailListForm;
        constructor() {
            super();
            this.form = new PurchaseOrderDetailListForm(this.idPrefix);

...
namespace LibraryManagementSolution.StallCustomer {
    ...
    export class ProductSaleDialog extends Serenity.EntityDialog<ProductSaleRow, any> {
        protected getFormKey() { return ProductSaleForm.formKey; }
        ...
        protected getNameProperty() { return ProductSaleRow.nameProperty; }
        protected getService() { return ProductSaleService.baseUrl; }
        protected getDeletePermission() { return ProductSaleRow.deletePermission; }
        protected getInsertPermission() { return ProductSaleRow.insertPermission; }
        protected getUpdatePermission() { return ProductSaleRow.updatePermission; }
        protected nextId = 0;
        protected sum = 0;
        protected form = new ProductSaleForm(this.idPrefix);

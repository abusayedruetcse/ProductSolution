...
{
    [FormScript("StallCustomer.ReturnOrExchange")]
    [BasedOnRow(typeof(ReturnOrExchangeRow), CheckNames = true)]
    public class ReturnOrExchangeForm
    {
        [Tab("General")]
        [Category("Order")]
        ...
        [Category("Add Return"), Collapsible(Collapsed = true)]
        [HalfWidth(JustThis = true)]
        [LookupEditor(typeof(BookRow))]
        public Int64 BookId2 { get; set; }
        [HalfWidth(JustThis = true)]
        public Int32 Quantity2 { get; set; }
        [HalfWidth(JustThis = true)]
        public Int32 Discount2 { get; set; }
        [HalfWidth(JustThis = true)]
        public Decimal UnitPrice2 { get; set; }
        [HalfWidth(JustThis = true)]
        public String AddOrderDetail2 { get; set; }
        [HalfWidth(JustThis = true)]
        public Decimal LineTotal2 { get; set; }
        [Category("Return List")]
        [ProductSaleDetailEditor]
        public List<ProductSaleDetailRow> ReturnBookList { get; set; }
        [Tab("New Book")]
        ...
        [HalfWidth(JustThis = true)]
        [ProductSalePaymentEditor]
        public List<ProductSalePaymentRow> CashBackList { get; set; }
        [HalfWidth(JustThis = true)]
        [ProductSalePaymentEditor]

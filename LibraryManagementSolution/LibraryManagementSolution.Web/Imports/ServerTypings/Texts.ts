namespace LibraryManagementSolution.Texts {
    ...
    declare namespace Db {
        ...
        namespace AdminManagement {
            ...
            namespace Book {
                export const AuthorAbout: string;
                export const AuthorBirthDate: string;
                export const AuthorContactNo: string;
                export const AuthorId: string;
                export const AuthorMail: string;
                ...
                export const TranslatorAbout: string;
                export const TranslatorBirthDate: string;
                export const TranslatorContactNo: string;
                export const TranslatorId: string;
                export const TranslatorMail: string;
        ...
        namespace PublisherStall {
            ...
            namespace PurchaseOrderPayment {
                ...
                export const PurchaseOrderId: string;
                export const PurchaseOrderInitialLess: string;
                export const PurchaseOrderInitialPaid: string;
                export const PurchaseOrderOrderDate: string;
                export const PurchaseOrderOther: string;
                export const PurchaseOrderPaymentId: string;
                export const PurchaseOrderPublisherId: string;
                export const PurchaseOrderServiceCharge: string;
                export const PurchaseOrderStatus: string;
                export const PurchaseOrderSubTotal: string;
                export const PurchaseOrderTokenNo: string;
                export const PurchaseOrderTotalPayable: string;
            }
        }
    }

...
namespace MVC
{
    public static class Views
    {
        ...
        public static class AdminManagement
        {
            ...
            {
                public const string AuthorIndex = "~/Modules/AdminManagement/Author/AuthorIndex.cshtml";
            }

            public static class Book
            {
                public const string BookIndex = "~/Modules/AdminManagement/Book/BookIndex.cshtml";
            }
            ...
            {
                public const string TopicIndex = "~/Modules/AdminManagement/Topic/TopicIndex.cshtml";
            }
